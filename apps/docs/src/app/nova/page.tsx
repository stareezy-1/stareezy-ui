...
const COMPONENT_DEFS: ComponentDef[] = [
  ...
  },
  {
    ...
    icon: "▥",
    category: "Layout",
    defaultProps: { spacing: 8, direction: "horizontal" },
  },
  {
    type: "Grid",
    label: "Grid",
  ...
  },
  {
    ...
    icon: "▢",
    category: "Buttons",
    defaultProps: { variant: "primary", color: "#ff6a1a" },
  ...
  },
  {
    ...
    icon: "⌨",
    category: "Inputs",
    defaultProps: { placeholder: "Type here...", width: 240 },
    defaultChildren: "",
  },
  {
    type: "Checkbox",
  ...
  },
  {
    ...
    icon: "━",
    category: "Inputs",
    defaultProps: { min: 0, max: 100, value: 50, width: 200 },
  },
  {
    type: "FileDropZone",
    label: "FileDropZone",
    icon: "📂",
    category: "Inputs",
    defaultProps: { accept: "image/*", maxFiles: 5 },
  },
  {
    type: "Table",
    label: "Table",
  ...
  },
  {
    ...
    icon: "▨",
    category: "Data",
    defaultProps: { value: 65, max: 100, width: 240 },
  },
  {
  ...
  },
  {
    ...
    icon: "◉",
    category: "Data",
    defaultProps: { text: "New", color: "#ff6a1a" },
  },
  {
    type: "Tag",
    label: "Tag",
    icon: "◈",
    category: "Data",
    defaultProps: { text: "stable", color: "#22c55e" },
  },
  {
    type: "NavBar",
    label: "NavBar",
    icon: "≡",
    category: "Navigation",
    defaultProps: { items: 3, brand: "App" },
  },
  {
    type: "Tabs",
    label: "Tabs",
  ...
  },
  {
    ...
    icon: "◀▶",
    category: "Navigation",
    defaultProps: { total: 10, current: 1 },
  },
  {
    type: "Modal",
    label: "Modal",
    icon: "◻",
    category: "Overlay",
    defaultProps: { title: "Modal Title", width: 400 },
  ...
  },
  {
    ...
    icon: "▤",
    category: "Overlay",
    defaultProps: { side: "right", width: 320 },
  },
  {
    type: "Tooltip",
    label: "Tooltip",
  ...
  },
  {
    ...
    icon: "▾",
    category: "Overlay",
    defaultProps: { items: 3, label: "Menu" },
  },
  {
    type: "CommandPalette",
    ...
    icon: "⌘",
    category: "Overlay",
    defaultProps: { placeholder: "Search commands..." },
  },
  {
    type: "Avatar",
    label: "Avatar",
    icon: "◒",
    category: "Media",
    defaultProps: { size: 40, initials: "SU" },
  },
  {
    type: "Skeleton",
    label: "Skeleton",
  ...
  },
  {
    ...
    icon: "─",
    category: "Media",
    defaultProps: { color: "var(--color-border)" },
  },
  {
    type: "Card",
    label: "Card",
  ...
  },
  {
    ...
    icon: "◐",
    category: "Feedback",
    defaultProps: { message: "Operation successful", type: "success" },
  },
  {
    type: "Clipboard",
    label: "Clipboard",
  ...
  },
  {
    ...
    icon: "⤡",
    category: "Feedback",
    defaultProps: { defaultWidth: 400, minWidth: 200 },
  },
  {
    type: "ProgressPanel",
    label: "ProgressPanel",
...
function renderPreview(node: CanvasNode, theme: ThemeMode): JSX.Element {
  const s: React.CSSProperties = {
    ...
    height:
      typeof node.props.height === "number" ? node.props.height : undefined,
    overflow: "hidden",
  ...
  switch (node.type) {
      ...
      return (
        ...
        >
          {node.children.length > 0
            ? node.children.map((c) => renderPreview(c, theme))
            : label}
        </div>
      );
    case "Box":
      return (
        <div
          style={{
            ...s,
            minHeight: 60,
            background: (node.props.bg as string) || "var(--color-surface)",
          }}
        >
          {node.children.length > 0
            ? node.children.map((c) => renderPreview(c, theme))
      ...
      return (
        <div
          style={{
            ...
            minHeight: 60,
            gap:
              typeof node.props.spacing === "number" ? node.props.spacing : 8,
            flexDirection:
              node.props.direction === "horizontal" ? "row" : "column",
            alignItems: "stretch",
          }}
        >
          {node.children.length > 0
      ...
      return (
        <div
          style={{
            ...s,
            display: "grid",
            gridTemplateColumns: `repeat(${node.props.columns || 2}, 1fr)`,
            gap: typeof node.props.gap === "number" ? node.props.gap : 12,
            minHeight: 80,
          }}
        >
          {node.children.length > 0
          ...
          style={{
            ...
            background:
              node.props.variant === "outline"
                ? "transparent"
                : node.props.variant === "ghost"
                ? "transparent"
                : (node.props.color as string) || "#ff6a1a",
            color: "#fff",
            fontWeight: 700,
            cursor: "pointer",
            fontSize: "0.85rem",
            border:
              node.props.variant === "outline"
                ? `2px solid ${node.props.color || "#ff6a1a"}`
                : undefined,
          }}
        >
          {node.text || "Button"}
    ...
    case "IconButton":
      return (
        <div
          style={{
            ...s,
            width: typeof node.props.size === "number" ? node.props.size : 32,
            height: typeof node.props.size === "number" ? node.props.size : 32,
            borderRadius: "50%",
            ...
            cursor: "pointer",
            fontSize:
              typeof node.props.size === "number" ? node.props.size * 0.5 : 16,
          }}
        >
      ...
      return (
        <div
          style={{
            ...
            fontSize: "0.85rem",
            width:
              typeof node.props.width === "number" ? node.props.width : 240,
          }}
        >
          {(node.props.placeholder as string) || "Type here..."}
        </div>
      );
    case "Checkbox":
      return (
        ...
        >
          ...
          />
          {(node.props.label as string) || "Option"}
        </div>
      );
    case "Switch":
      return (
        ...
        >
          ...
          {(node.props.label as string) || "Toggle"}
        </div>
      );
    case "Slider":
      return (
        ...
        >
          ...
          >
            <div
              style={{
                width: `${
                  (((node.props.value as number) || 0) /
                    ((node.props.max as number) || 100)) *
                  100
                }%`,
                height: "100%",
                borderRadius: 4,
    ...
    case "CircularProgress":
      return (
        <div
          style={{
            ...s,
            width: typeof node.props.size === "number" ? node.props.size : 48,
            height: typeof node.props.size === "number" ? node.props.size : 48,
            borderRadius: "50%",
      ...
      return (
        <div
          style={{
            ...
            padding: "2px 8px",
            borderRadius: 9999,
            background: (node.props.color as string) || "#ff6a1a",
            color: "#fff",
            fontSize: "0.75rem",
            fontWeight: 600,
          }}
      ...
      return (
        <div
          style={{
            ...
            padding: "2px 10px",
            borderRadius: 4,
            border: `1px solid ${(node.props.color as string) || "#22c55e"}`,
            color: (node.props.color as string) || "#22c55e",
            fontSize: "0.75rem",
          }}
        >
          {(node.props.text as string) || "Tag"}
        </div>
      );
    case "Card":
      return (
        <div
          style={{
            ...s,
            flexDirection: "column",
            padding: typeof node.props.p === "number" ? node.props.p : 16,
            borderRadius: 12,
            background: "var(--color-surface)",
            border: "1px solid var(--color-border)",
            width:
              typeof node.props.width === "number" ? node.props.width : 280,
            minHeight: 100,
          }}
        >
          {node.children.length > 0
      ...
      return (
        ...
        >
          <span style={{ fontWeight: 700 }}>
            {(node.props.brand as string) || "App"}
          </span>
          {Array.from({ length: (node.props.items as number) || 3 }).map(
            (_, i) => (
    ...
    case "Tabs":
      return (
        ...
        >
          {Array.from({ length: (node.props.tabs as number) || 3 }).map(
            (_, i) => (
              <span
                key={i}
                style={{
                  padding: "8px 16px",
                  borderBottom:
                    i === ((node.props.active as number) || 0)
            ...
            (_, i) => (
              ...
              >
                ...
                <span
                  style={{
                    color:
                      i === ((node.props.items as number) || 3) - 1
                        ? "var(--color-text)"
                        : "var(--color-text-2)",
                  }}
                >
    ...
    case "Pagination":
      return (
        <div style={{ ...s, flexDirection: "row", gap: 4, padding: 4 }}>
          {Array.from({
            length: Math.min((node.props.total as number) || 10, 5),
          }).map((_, i) => (
            <span
              key={i}
              style={{
                ...
                justifyContent: "center",
                background:
                  i + 1 === ((node.props.current as number) || 1)
                    ? "var(--brand-primary)"
                    : "var(--color-surface)",
                fontSize: "0.75rem",
                cursor: "pointer",
      ...
      return (
        <div
          style={{
            ...
            height: 1,
            minHeight: 1,
            background: (node.props.color as string) || "var(--color-border)",
            width: "100%",
          }}
        />
      );
        ...
        <div
          style={{
            ...
            width:
              typeof node.props.width === "number" ? node.props.width : 240,
            height:
              typeof node.props.height === "number" ? node.props.height : 16,
            borderRadius: 4,
            background: "var(--color-surface-2)",
    ...
    case "Avatar":
      return (
        <div
          style={{
            ...s,
            width: typeof node.props.size === "number" ? node.props.size : 40,
            ...
            fontWeight: 700,
            fontSize:
              typeof node.props.size === "number" ? node.props.size * 0.35 : 14,
          }}
        >
          {(node.props.initials as string) || "SU"}
        </div>
      );
    case "Modal":
      return (
        <div
          style={{
            ...
            border: "1px solid var(--color-border)",
            width:
              typeof node.props.width === "number" ? node.props.width : 400,
            boxShadow: "0 20px 60px rgba(0,0,0,0.5)",
            minHeight: 120,
          }}
        >
          <span style={{ fontWeight: 700, marginBottom: 8 }}>
            {(node.props.title as string) || "Modal"}
          </span>
      ...
      return (
        <div
          style={{
            ...
            width:
              typeof node.props.width === "number" ? node.props.width : 320,
            minHeight: 200,
            position: "relative" as const,
          }}
        >
          <span style={{ fontWeight: 700, marginBottom: 16 }}>Drawer</span>
          <span style={{ fontSize: "0.8rem", opacity: 0.7 }}>
            Side panel content
          </span>
        </div>
    ...
    case "Tooltip":
      return (
        ...
        >
          {(node.props.text as string) || "Tooltip"}
        </div>
      );
    case "Dropdown":
      return (
        ...
        >
          ...
          >
            {(node.props.label as string) || "Menu"}
          </span>
          {Array.from({ length: (node.props.items as number) || 3 }).map(
            (_, i) => (
              <span
      ...
      return (
        <div
          style={{
            ...
            borderRadius: 8,
            background:
              node.props.type === "error"
                ? "rgba(220,20,60,0.15)"
                : node.props.type === "warning"
        ...
        >
          <span style={{ fontSize: "0.8rem" }}>
            {(node.props.message as string) || "Toast message"}
          </span>
        </div>
      );
    case "Clipboard":
      return (
        ...
        >
          <span style={{ fontSize: "0.8rem" }}>
            {(node.props.text as string) || "Copy me!"}
          </span>
      ...
      return (
        <div
          style={{
            ...
            border: "1px solid var(--color-border)",
            width:
              typeof node.props.defaultWidth === "number"
                ? node.props.defaultWidth
                : 400,
            minHeight: 40,
            position: "relative" as const,
          }}
    ...
    case "ProgressPanel":
      return (
        ...
        >
          {Array.from({ length: (node.props.steps as number) || 4 }).map(
            (_, i) => (
              <div
                key={i}
                style={{
                  ...
                  borderRadius: 2,
                  background:
                    i < ((node.props.current as number) || 2)
                      ? "var(--brand-primary)"
                      : "var(--color-surface-2)",
                }}
              />
    ...
    case "CommandPalette":
      return (
        ...
        >
          ...
          >
            {(node.props.placeholder as string) || "Search..."}
          </span>
        </div>
      );
    default:
...
export default function NovaPage() {
  const [nodes, setNodes] = useState<CanvasNode[]>([
    { id: generateId(), type: "Page", props: {}, children: [], text: "Page" },
  ]);
  ...
  function handleExport() {
    ...
    const code = `import { ${pageChildren
      .map((c) => c.type)
        ...
        <div style={{ flex: 1, overflow: "auto" }}>
          {categories.map((cat) => (
            <div key={cat}>
              ...
              {openCats[cat] &&
                COMPONENT_DEFS.filter((c) => c.category === cat).map((def) => (
                  <div
                    key={def.type}
          ...
          <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
            {THEMES.map((t) => (
              <button
                ...
                style={
                  t === theme
                    ? { ...style.themeBtn, ...style.themeBtnActive }
                    : style.themeBtn
                }
                onClick={() => setTheme(t)}
              >
            ...
            {nodes.length === 0 && (
              <div style={style.emptyCanvas}>
                ...
                <span style={{ fontSize: "0.7rem" }}>
                  or double-click items in the palette
                </span>
              </div>
            )}
          </div>
        ...
        {showCode && (
          <div style={{ ...style.codePanel, height: 240 }}>
            ...
            >
              ...
              >
                <button onClick={handleCopyCode} style={style.tokenBtn}>
                  Copy
                </button>
                <button onClick={handleExport} style={style.tokenBtn}>
                  Download
                </button>
              </div>
            </div>
            <div style={{ flex: 1, overflow: "auto" }}>
              ...
              {codeTab === "preview" && (
                ...
                >
                  {(nodes[0]?.children ?? []).map((c) =>
                    renderPreview(c, theme),
                  )}
                </div>
              )}
              {codeTab === "export" && (
                ...
                >
                  ...
                  <span style={{ fontSize: "0.65rem", opacity: 0.4 }}>
                    Code uses @stareezy-ui/components and @stareezy-ui/tokens
                  </span>
                </div>
              )}
            </div>
        ...
        <div style={{ display: "flex" }}>
          {(["style", "content", "layers"] as TabId[]).map((t) => (
            <button
              ...
              style={
                tab === t
                  ? { ...style.tabBtn, ...style.tabBtnActive }
                  : style.tabBtn
              }
              onClick={() => setTab(t)}
            >
                ...
                <>
                  ...
                  <div style={style.propGroup}>
                    ...
                    <div style={style.propRow}>
                      ...
                      <input
                        style={style.propInput}
                        type="number"
                        value={(sel.props.p as number) || 0}
                        onChange={(e) =>
                          updateNodeProps(
                            sel.id,
                            "p",
                    ...
                    <div style={style.propRow}>
                      ...
                      <input
                        style={style.propInput}
                        type="number"
                        value={(sel.props.borderRadius as number) || 0}
                        onChange={(e) =>
                          updateNodeProps(
                            sel.id,
                            "borderRadius",
                    ...
                    <div style={style.propRow}>
                      ...
                      <input
                        style={style.propInput}
                        type="number"
                        value={(sel.props.width as number) || ""}
                        placeholder="auto"
                        onChange={(e) =>
                          updateNodeProps(
                            sel.id,
                    ...
                    <div style={style.propRow}>
                      ...
                      <input
                        style={style.propInput}
                        type="number"
                        value={(sel.props.height as number) || ""}
                        placeholder="auto"
                        onChange={(e) =>
                          updateNodeProps(
                            sel.id,
                  ...
                  <div style={style.propGroup}>
                    ...
                    <div style={style.propRow}>
                      ...
                      <input
                        style={style.propInput}
                        value={(sel.props.bg as string) || ""}
                        placeholder="default"
                        onChange={(e) =>
                          updateNodeProps(sel.id, "bg", e.target.value)
                        }
                      />
                    </div>
                    <div style={style.propRow}>
                      ...
                      <input
                        style={style.propInput}
                        value={(sel.props.color as string) || ""}
                        placeholder="default"
                        onChange={(e) =>
                          updateNodeProps(sel.id, "color", e.target.value)
                        }
                      />
                    </div>
                    {(sel.type === "Stack" ||
                      ...
                      <div style={style.propRow}>
                        ...
                        <input
                          style={style.propInput}
                          type="number"
                          value={(sel.props.spacing as number) || 8}
                          onChange={(e) =>
                            updateNodeProps(
                              sel.id,
                              "spacing",
                  ...
                  {Object.keys(sel.props)
                    ...
                    .map((k) => (
                      <div key={k} style={style.propRow}>
                        ...
                        <input
                          style={style.propInput}
                          value={(sel.props[k] as string) || ""}
                          onChange={(e) =>
                            updateNodeProps(sel.id, k, e.target.value)
                          }
                        />
                      </div>
                    ))}
              ...
              {nodes.map((node) => (
                <div key={node.id}>
                  <div
                    style={
                      selectedId === node.id
                        ? { ...style.layerItem, ...style.layerItemSelected }
                        : style.layerItem
                    }
                    ...
                    <div
                      ...
                      style={
                        selectedId === child.id
                          ? {
                              ...style.layerItem,
                              ...style.layerItemSelected,
                              paddingLeft: 28,
                            }
                          : { ...style.layerItem, paddingLeft: 28 }
                      }
...
function renderNode(
  ...
  const baseStyle: React.CSSProperties = {
    ...
    cursor: "pointer",
    background:
      node.type === "Page" ? "var(--color-bg)" : "var(--color-surface)",
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        if (!isSelected)
          e.currentTarget.style.borderColor = "rgba(255,106,26,0.3)";
      }}
      onMouseLeave={(e) => {
