...
export default function ThanksPage() {
  return (
    ...
    >
      ...
      <h2>The aurora palette</h2>
      <p>
        The aurora color system is the visual heart of this library. Kukuh
        defined every stop — from the deep space blacks to the neon greens and
        cosmic purples.
      </p>
      ...
      >
        ...
        <div
          style={{
            height: 56,
            background:
              "linear-gradient(90deg, #050505 0%, #0a0a1a 15%, #1a0a2e 30%, #7c3aed 50%, #00ff88 75%, #14F1D8 100%)",
          }}
        />
        {/* Swatches */}
        <div
        ...
        >
          {[
            { name: "deepSpace", hex: "#050505" },
            { name: "cosmicGray", hex: "#1a1a2e" },
            { name: "nebulaPurple", hex: "#7c3aed" },
            { name: "auroraGreen", hex: "#00ff88" },
            { name: "tealGlow", hex: "#14F1D8" },
            { name: "starWhite", hex: "#ffffff" },
          ].map((swatch) => (
            <div
              key={swatch.name}
              style={{
