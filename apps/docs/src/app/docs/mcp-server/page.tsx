  ...
  return (
    ...
    >
      ...
      <Step n={1} title="Install the MCP server package">
        <p>
          Run the server package directly with npx — no global install needed:
        </p>
        <div style={codeBlock}>
      ...
      <Step n={2} title="Configure your AI tool">
        <p>
          ...
          configuration format — see the <strong>Configuration</strong> section
          below for Claude Desktop, Cursor, and others.
        </p>
      </Step>
...
`}</code>
  ...
  "mcpServers": {
    "stareezy-ui": {
      ...
      <p>
        Cursor automatically detects and connects to MCP servers listed in your
        project&apos;s <code>.cursor/mcp.json</code>. No restart required — just
        start prompting in Composer or Chat.
      </p>
