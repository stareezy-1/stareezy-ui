...
// Asserts:
//   1. The virtual:quasify-ui/styles module is produced by quasifyVitePlugin.
 ...
 * - Imports from @quasify-ui/components (exercises the Vite transform)
 */
const App = () => (
  <Box p={16} display="flex" flexDirection="column" gap={8}>
    <Box p={8} style={{ background: "white", borderRadius: 4 }}>
      <p>Quasify-ui × Vite integration test</p>
    </Box>
  </Box>
);
